    ...
    <div class="container">
        <div class="row text-center text-md-start">
            ...
            <div class="col-12 col-md-4 mb-3 mb-md-0 text-md-end">
                <h5 class="text-warning fw-bold">Desarrollado por</h5>
                <p class="small text-light ">Caprino Cardoso Lautaro Ivan <br>Mercado Sofia Victoria
                    <br>Federico Sabrina Lucia<br>Aleman Quispia Axel Fabricio</p>
            </div>
        ...
        <div class="text-center w-100 mt-3">
            <span class="text-light small" style="font-size: 0.8rem;">Proyecto Académico • Tecnicatura en Desarrollo Web</span>
        </div>
    </div>
</footer>