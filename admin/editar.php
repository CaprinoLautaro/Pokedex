...
if (!$pokemon) { die("Pokémon no encontrado."); }
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <select name="tipo1_id" class="form-select">
                                <?php while($t = $resultadoTipos->fetch_assoc()): ?>
                                    <option value="<?php echo $t['id']; ?>" <?php if($t['id'] == $pokemon['tipo1_id']) echo 'selected'; ?>><?php echo $t['nombre']; ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        <div class="col-12 col-sm-6">
                            ...
                            <select name="tipo2_id" class="form-select">
                                ...
                                <?php $resultadoTipos->data_seek(0); while($t = $resultadoTipos->fetch_assoc()): ?>
                                    <option value="<?php echo $t['id']; ?>" <?php if($t['id'] == $pokemon['tipo2_id']) echo 'selected'; ?>><?php echo $t['nombre']; ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    </div>
